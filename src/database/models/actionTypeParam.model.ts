 ...
 */
export class ActionTypeParam extends Model {
  declare ActionTypeId: number;
  declare ParamId: number;

  static initModel(sequelize: Sequelize): void {
    ActionTypeParam.init(
      {
        ActionTypeId: {
      ...
      },
      {
        ...
        tableName: "actionsTypes_params", // here names can be pass in camel case for consistency
      }
    );
  }
}
