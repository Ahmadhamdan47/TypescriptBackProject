 ...
 */
export class EquipmentTypeEquipmentProperty extends Model {
  declare EquipmentTypeId: number;
  declare EquipmentPropertyId: number;

  static initModel(sequelize: Sequelize): void {
    EquipmentTypeEquipmentProperty.init(
      {
        EquipmentTypeId: {
      ...
      },
      {
        ...
        tableName: "equipmentsTypes_equipmentsProperties", // here names can be pass in camel case for consistency
      }
    );
  }
}
