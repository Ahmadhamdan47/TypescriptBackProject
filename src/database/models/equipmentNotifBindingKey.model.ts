 ...
 */
export class EquipmentNotifBindingKey extends Model {
  declare EquipmentId: number;
  declare NotifBindingKeyId: number;

  static initModel(sequelize: Sequelize): void {
    EquipmentNotifBindingKey.init(
      {
        EquipmentId: {
      ...
      },
      {
        ...
        tableName: "equipments_notifBindingKeys", // here names can be pass in camel case for consistency
      }
    );
  }
}
